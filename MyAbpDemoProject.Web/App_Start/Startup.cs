...
﻿using Abp.Owin;
using MyAbpDemoProject.Api.Controllers;
using MyAbpDemoProject.Web;
...
namespace MyAbpDemoProject.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in MyAbpDemoProjectWebModule)
